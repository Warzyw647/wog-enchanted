...
- Message at Dwarf Ellam's hose fixed. He no longer "walks into his house" if he's not in the army or if he got upgraded.
...
- Increased Tactics from Advanced to Expert temporarily for the time of Monk encounters (If player has Advanced Tactics). This is to allow deploying a stack closer to the opponents than to allies and run towards them when Berserked.
